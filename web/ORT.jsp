                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%
                                                                    ...
                                                                    //String lan = calcu.language_identity(ort);
                                                                    if (mea.length() == 0) {
                                                                        mea = "null";
                                                                    }
...
%>
                                                                <table border="0" cellspacing="5" cellpadding="5" style="background-color: #2F89DF">
                                                                    <tbody>
                                                                        ...
                                                                        <tr><td><input type="text" name="pos"  value="null"/></td>
                                                                            <td><input type="text" class="keyboardInput" style="font-size: xx-large;" name="pon"  value="<%= write.getPon(ort, pos33, lan)%>"/></td>
                                                                            <td><input type="text" name="mea"  value="<%=mea%>"/></td>
                                                                            <td><input type="text" class="keyboardInput" style="font-size:large; display:none" id ="idi_0"  name="idi" value=""/><input type="checkbox" onclick="hide('idi_0');"/></td></tr>
                                                                            <%  }
                                                                            %>
                                                                        <input type="hidden" name="lan" value="<%=lan%>" />
                                                                        <input type="hidden" name="pos33" value="<%=pos33%>" />
                                                                        <tr><td align="center" colspan="3"><input type="submit" value="save" name="save" style="height: 50px; width: 300px;" /></td>
                                                                            <td align="center" >
