    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function ADD_language(id){
                var k = id.split("-")[0];
                document.getElementById("roles"+k).value = document.getElementById("roles"+k).value +"."+document.getElementById(id).value;
            }
        </script>
                                                            ...
                                                            <sub>Sponsored By Department of Electronics and Information Technology (DEITY),</sub><br>
                                                                ...
                                                                <tr>
                                                                    <td height="251" align="center" valign="top"><br/>
                                                                        ...
                                                                        <a style="font-size: large; color: #DF0000; border-style: outset; border-color: #000; float: left" href="admin_delete.jsp">Clear Table</a>
                                                                        <form name="register" action="admin_success.jsp" method="get">
                                                                            <%
                                                                                ...
                                                                                int K = 0;
                                                                                try {
                                                                                    String resultString = "SELECT * FROM temp_register";
                                                                                    ...
                                                                                    out.print("<th>Name</th><th>Password</th><th>Email</th><th>Additional</th><th>Languages</th><th colspan='2'>Confirm User</th>");
                                                                                    while (rs.next()) {
                                                                                        ...
                                                                                        out.print("<td>");
                                                                                        String languages[] = rs.getString(6).split("\\.");
                                                                                        for (int i = 0; i < languages.length; i++) {
                                                                                            out.print("<input type='checkbox' id='" + K + "-" + i + "'  value='" + languages[i] + "' onclick='ADD_language(this.id)'/>" + languages[i]);
                                                                                            out.print("<br>");
                                                                                        }
                                                                                        out.print("</td>");
                                                                                        out.print("<td><input type='text' name='roles" + K + "' id='roles" + K + "'/></td>");
                                                                                        out.print("<td align='right'><input type='checkbox' id='confirm" + K + "' name='confirm" + K + "' value='off' onclick='value_v(this.id)'/></td></tr>");
                                                                                        K++;
                                                                                    }
                                                                                    out.print("</table><br/>");
                                                                                    out.print("<input type='submit' value='Confirmed' name='submit' />");
                                                                                } catch (Exception ex) {
                                                                                ...
                                                                                request.getSession().setAttribute("regis", K);
                                                                            %>
                                                                        </form>
                                                                        <hr></hr>
                                                                        <p>&nbsp;</p>
