            ...
            <tr>
                <td width="100%" height="145" align="center" valign="bottom">
                    <table width="900" height="145" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td width="750" align="left" valign="middle">
                                            <table width="100%" height="63" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="center">
                                                        <a style="color: white; font-size:200%"><% out.print(language);%></a><br>                                                        
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>                                        
                        ...
                        <a href="administrator.jsp">Back to ADMIN page</a>
                        ...
                        <tr>
                            <td>                     
                                <table border="0" cellspacing="5" cellpadding="5" align="center" width="70%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="9" style="" align="center" class="data_link">
                                                ...
                                                %>
                                                <a href="edit_language_databse.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>&language=<%=language%>"> <b><< Previous&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                                                <%
                                                    }
                                                ...
                                                %>
                                                <a href="edit_language_databse.jsp?iPageNo=<%=i%>&language=<%=language%>" style="cursor:pointer;color: red"><b><%=i%></b></a>
                                                <%
                                                } else if (i <= iTotalPages) {
                                                %>
                                                <a href="edit_language_databse.jsp?iPageNo=<%=i%>&language=<%=language%>"><%=i%></a>
                                                <%
                                                        }
                                                    }
                                                    if (iTotalPages > iTotalSearchRecords && i < iTotalPages) {
                                                %>
                                                <a href="edit_language_databse.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>&language=<%=language%>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Next >> </a>
                                                <%
                                                        }
                                                    }
                                                %>
                                    ...
                                    <form method="get" action="edit_language_databse_success.jsp">
                                        <%int kk = 0;
