                                        ...
                                        <td>
                                            <%
                                                        ...
                                                        for (int n = 0; n < idx.size(); n++) {
                                                            ...
                                                            try {
                                                                String resultString = "SELECT * FROM " + lan + " WHERE ORTHOGRAPHY = '" + ort_n + "' AND POS like '%" + pos_A[0] + "%'";
                                                                ...
                                                                if (!rs.next()) {
                                                                    ...
                                                                    if(updateQuery!=0){
                                                                        out.println("Successfully Inserted " + ort_n + "--" + pos_n + "---" + pon_n + "<br>");
                                                                    }
                                                                } else {
                                                                    out.println("Already Exists "+rs.getString(2) + "--" + rs.getString(3) + "---" + rs.getString(5)+"<br>");
                                                                }
