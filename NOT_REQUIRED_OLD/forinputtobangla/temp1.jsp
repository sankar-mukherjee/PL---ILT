...
<html>
    ...
    <body>
        <FORM action="temp1.jsp" method="get" >
        <table border="1">
                            <thead>
                                <tr>
                                    <th>IPA Symbols</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #b56a9e"><input type="text" name="pm" value="" /></td>
                                </tr>
                                <tr>
        ...
        <%
                                    ...
                                    String place = request.getParameter("pm");
                                    ...
                                    if (ipa != null && grapheme != null && place != null ) {
                                        ...
                                        if (ipa != "" && grapheme != "" && place != "" ) {
                                            ...
                                            try {
                                                ...
                                                String queryString = "INSERT INTO banglavowel (IPA, GRAPHEME, INITIALL, MEDIALLY, FINALL, PM) VALUES (?,?,?,?,?,?)";
