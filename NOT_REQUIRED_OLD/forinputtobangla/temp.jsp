    ...
    <body>
        ...
        <table border="1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="background-color: #b56a9e"><input type="text" name="ipa" value=""  class="keyboardInput"/></td>
                                    <td style="background-color: #b56a9e"><input type="text" name="grapheme" value=""  class="keyboardInput"/></td>
                                    ...
                                    <td style="background-color: #b56a9e"><input type="text" name="place" value="" /></td>
                                    <td style="background-color: #b56a9e"><input type="text" name="manner" value=""  class="keyboardInput"/></td>
        ...
        <%
                                    ...
                                    if (ipa != null && grapheme != null && place != null ) {
                                        // check if the text box having only blank spaces
                                        if (ipa != "" && grapheme != "" && place != "" ) {
                                            ...
                                            try {
                                                ...
                                                String queryString = "INSERT INTO banglacons (IPA, GRAPHEME, INITIALL, MEDIALLY, FINALL, PLACE, MANNER) VALUES (?,?,?,?,?,?,?)";
                                                /* createStatement() is used for create statement object that is used for
                                                sending sql statements to the specified database. */
                                                pstatement = connection.prepareStatement(queryString);
                                                pstatement.setString(1, ipa);
                                                pstatement.setString(2, grapheme);
                                                pstatement.setString(3, initiall);
                                                pstatement.setString(4, medially);
                                                pstatement.setString(5, finall);
                                                pstatement.setString(6, place);
                                                pstatement.setString(7, manner);
