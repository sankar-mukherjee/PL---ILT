 ...
 * @author Prasanta
 */
public class DownloadFile4 extends HttpServlet{
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String res = "SELECT * FROM "+Language+" GROUP BY ORTHOGRAPHY LIMIT "+Start+","+End+" ";
                ...
                for (int p = 0; p < nrows; p++) {
                    String result = "SELECT * FROM "+Language+" where ORTHOGRAPHY='" + a[p][1] + "'";
                ...
                for (int r = 0; r < nrows; r++) {
                    if (c[r] == 1) {
                        ...
                        for (int j = 0; j < d.size(); j++) {
                            String resest = "SELECT * FROM "+Language+" where ORTHOGRAPHY='" + a[r][1] + "' AND POS like'%" + po[r][j] + "%'";
                            //statement=connection.createStatement();
