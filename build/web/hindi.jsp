        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <%String connectionURL = "jdbc:mysql://localhost:3306/ide?useUnicode=true&characterEncoding=UTF-8";
                        ...
                        try {
                            ...
                            String resultString = "SELECT * FROM hindi_cons";
                            statement = connection.createStatement();
                            rs = statement.executeQuery(resultString);

                            String resultString2 = "SELECT * FROM hindivowel";
                                    ...
                                    <tr>
                                        <td align="left" valign="top" class="style19">
                                            <p><a href="javascript:toggle('toggleText1','switchText1');" rel="nofollow">
                                                    <span class="link2" style="font-size: 18pt;">Hindi Phonemic Distribution (Consonants)</span>
                                    ...
                                    <tr>
                                        <td align="left" valign="top" class="style19">
                                            <p><a href="javascript:toggle('toggleText2','switchText2');" rel="nofollow">
                                                    <span class="link2" style="font-size: 18pt;">Hindi Phonemic Distribution (Oral Vowels)</span>
                                                            ...
                                                            <table border="0" cellspacing="5" cellpadding="5" align="center">
                                                                <thead>
                                                                    <tr style="background-color: #2F89DF">
                                                                        <th>IPA Symbols</th>
                                                                        <th>Phoneme label</th>
                                                                        <th>Related Grapheme (in isolation)</th>
                                                                        <th>Related Grapheme (with preceding consonants)</th>
                                                                        <th colspan="3"><table border="0" width="100%">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th colspan="3">Occurrence in Hindi Words</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <%}%>
                                                                    <tr><td colspan="9">All the vowels (except ऑ) have nasal counterparts.</td></tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                    </p></div>
