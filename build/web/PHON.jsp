                                        ...
                                        <tr>
                                            <td>
                                                <%
                                                            ...
                                                            <tr><th>Words</th><th>POS</th><th>Pronunciation</th><th>Meaning</th><th>Standard Variation</th></tr>
                                                           ...
                                                           <% for (int i = 0; i < idx.size(); i++) {
                                                                ...
                                                                if (pos != null && pos != "") {
                                                                    ...
                                                                    <td><input type="text" name="pos<%= i %>" value="null"/></td>
                                                                    ...
                                                                    <td><input type="text" class="keyboardInput" style="font-size: large; display: none" id ="idi<%=i%>" name="idi<%=i%>" value=""/><input type="checkbox" onclick="hide('idi<%=i%>')"/></td></tr>
                                                                  <%  kk=""+i;
                                                                    phon.add(kk);
                                                                     }
                                                            }%>
